...
AtlasLoot_Data["LEGENDARIES"] = {
	...
	AtlasLoot_Data["MPLUSPLATE"] = {
		...
		{ 27, 93162, "", "=q5=", "=ds=Plate"};
		{ 28, 93165, "", "=q5=", "=ds=Plate"};
		{ 29, 93168, "", "=q5=", "=ds=Plate"};
		{ 30, 93189, "", "=q5=", "=ds=Plate"};
		Back = "MPLUSMENU";
	};
	...
	AtlasLoot_Data["MPLUSLEATHER"] = {
		...
		{ 21, 93163, "", "=q5=", "=ds=Leather"};
		{ 22, 93166, "", "=q5=", "=ds=Leather"};
		Back = "MPLUSMENU";
	};
	...
	AtlasLoot_Data["MPLUSCLOTH"] = {
		...
		{ 24, 93167, "", "=q5=", "=ds=Cloth"};	
		{ 25, 93169, "", "=q5=", "=ds=Cloth"};	
		{ 26, 93190, "", "=q5=", "=ds=Cloth"};		
		Back = "MPLUSMENU";
	};
	...
	AtlasLoot_Data["MPLUSWEAPONS"] = {
		{ 1, 93030, "", "=q5=", "=ds=Wand"};
		{ 2, 93084, "", "=q5=", "=ds=One-Hand, Axe"};
		{ 3, 93123, "", "=q5=", "=ds=Main Hand, Fist Weapon"};				
		{ 4, 93135, "", "=q5=", "=ds=Staff"};
		{ 5, 93026, "", "=q5=", "=ds="};
		{ 6, 93028, "", "=q5=", "=ds="};
		{ 7, 93031, "", "=q5=", "=ds="};
