...
---- Jewelcrafting
	...
	AtlasLoot_Data["LeatherLeatherArmorOld1"] = {
		...
		{ 10, "s24124", "19688", "=q4=Blood Tiger Breastplate", "=ds=#sr# 300"};
		{ 11, "s24125", "19689", "=q4=Blood Tiger Shoulders", "=ds=#sr# 300"};
		{ 12, "s28474", "22761", "=q4=Bramblewood Belt", "=ds=#sr# 300"};
		{ 13, "s28473", "22760", "=q4=Bramblewood Boots", "=ds=#sr# 300"};
		{ 14, "s28472", "22759", "=q4=Bramblewood Helm", "=ds=#sr# 300"};
		{ 15, "s19097", "15062", "=q4=Devilsaur Leggings", "=ds=#sr# 300"};
		{ 16, "s22921", "18504", "=q4=Girdle of Insight", "=ds=#sr# 300"};
		{ 17, "s23706", "19058", "=q4=Golden Mantle of the Dawn", "=ds=#sr# 300"};
		{ 18, "s19095", "15059", "=q4=Living Breastplate", "=ds=#sr# 300"};
		{ 19, "s22922", "18506", "=q4=Mongoose Boots", "=ds=#sr# 300"};
		{ 20, "s24123", "19687", "=q4=Primal Batskin Bracers", "=ds=#sr# 300"};
		{ 21, "s24122", "19686", "=q4=Primal Batskin Gloves", "=ds=#sr# 300"};
		{ 22, "s24121", "19685", "=q4=Primal Batskin Jerkin", "=ds=#sr# 300"};
		{ 23, "s26279", "21278", "=q4=Stormshroud Gloves", "=ds=#sr# 300"};
		{ 24, "s23704", "19049", "=q4=Timbermaw Brawlers", "=ds=#sr# 300"};
		{ 25, "s19090", "15058", "=q4=Stormshroud Shoulders", "=ds=#sr# 295"};
		{ 26, "s23705", "19052", "=q4=Dawn Treaders", "=ds=#sr# 290"};
		{ 27, "s19084", "15063", "=q4=Devilsaur Gauntlets", "=ds=#sr# 290"};
		{ 28, "s19086", "15066", "=q4=Ironfeather Breastplate", "=ds=#sr# 290"};
		{ 29, "s23703", "19044", "=q4=Might of the Timbermaw", "=ds=#sr# 290"};
		{ 30, "s19078", "15060", "=q4=Living Leggings", "=ds=#sr# 285"};
		Next = "LeatherLeatherArmorOld2";
		Back = "LEATHERWORKINGMENU";
	};

	AtlasLoot_Data["LeatherLeatherArmorOld2"] = {
		{ 1, "s19079", "15056", "=q4=Stormshroud Armor", "=ds=#sr# 285"};
		{ 2, "s19080", "15065", "=q4=Warbear Woolies", "=ds=#sr# 285"};
		{ 3, "s19067", "15057", "=q4=Stormshroud Pants", "=ds=#sr# 275"};
		{ 4, "s19068", "15064", "=q4=Warbear Harness", "=ds=#sr# 275"};
		{ 5, "s19062", "15067", "=q4=Ironfeather Shoulders", "=ds=#sr# 270"};
		{ 6, "s19061", "15061", "=q4=Living Shoulders", "=ds=#sr# 270"};
		{ 7, "s36074", "29964", "=q4=Blackstorm Leggings", "=ds=#sr# 260"};
		{ 8, "s36075", "29970", "=q4=Wildfeather Leggings", "=ds=#sr# 260"};
		{ 9, "s10647", "8349", "=q4=Feathered Breastplate", "=ds=#sr# 250"};
		{ 10, "s10632", "8348", "=q4=Helm of Fire", "=ds=#sr# 250"};
		{ 11, "s10630", "8346", "=q4=Gauntlets of the Sea", "=ds=#sr# 230"};
		{ 12, "s10621", "8345", "=q4=Wolfshead Helm", "=ds=#sr# 225"};
		{ 13, "s22711", "18238", "=q4=Shadowskin Gloves", "=ds=#sr# 200"};
		{ 14, "s3778", "4262", "=q4=Gem-studded Leather Belt", "=ds=#sr# 185"};
		{ 15, "s23399", "18948", "=q4=Barbaric Bracers", "=ds=#sr# 155"};
		{ 16, "s3770", "4253", "=q4=Toughened Leather Gloves", "=ds=#sr# 135"};
		{ 17, "s7955", "6468", "=q4=Deviate Scale Belt", "=ds=#sr# 115"};
		{ 18, "s19104", "15068", "=q3=Frostsaber Tunic", "=ds=#sr# 300"};
		{ 19, "s19102", "15090", "=q3=Runic Leather Armor", "=ds=#sr# 300"};
		{ 20, "s19091", "15095", "=q3=Runic Leather Pants", "=ds=#sr# 300"};
		{ 21, "s19103", "15096", "=q3=Runic Leather Shoulders", "=ds=#sr# 300"};
		{ 22, "s19101", "15055", "=q3=Volcanic Shoulders", "=ds=#sr# 300"};
		{ 23, "s19098", "15085", "=q3=Wicked Leather Armor", "=ds=#sr# 300"};
		{ 24, "s19092", "15088", "=q3=Wicked Leather Belt", "=ds=#sr# 300"};
		{ 25, "s19087", "15070", "=q3=Frostsaber Gloves", "=ds=#sr# 295"};
		{ 26, "s19081", "15075", "=q3=Chimeric Vest", "=ds=#sr# 290"};
		{ 27, "s19082", "15094", "=q3=Runic Leather Headband", "=ds=#sr# 290"};
		{ 28, "s19083", "15087", "=q3=Wicked Leather Pants", "=ds=#sr# 290"};
		{ 29, "s19074", "15069", "=q3=Frostsaber Leggings", "=ds=#sr# 285"};
		{ 30, "s19076", "15053", "=q3=Volcanic Breastplate", "=ds=#sr# 285"};
	...
	AtlasLoot_Data["LeatherLeatherArmorOld3"] = {
		{ 1, "s19073", "15072", "=q3=Chimeric Leggings", "=ds=#sr# 280"};
		{ 2, "s19072", "15093", "=q3=Runic Leather Belt", "=ds=#sr# 280"};
		{ 3, "s19071", "15086", "=q3=Wicked Leather Headband", "=ds=#sr# 280"};
		{ 4, "s19065", "15092", "=q3=Runic Leather Bracers", "=ds=#sr# 275"};
		{ 5, "s19063", "15073", "=q3=Chimeric Boots", "=ds=#sr# 275"};
		{ 6, "s19066", "15071", "=q3=Frostsaber Boots", "=ds=#sr# 275"};
		{ 7, "s19055", "15091", "=q3=Runic Leather Gauntlets", "=ds=#sr# 270"};
		{ 8, "s19059", "15054", "=q3=Volcanic Leggings", "=ds=#sr# 270"};
		{ 9, "s19053", "15074", "=q3=Chimeric Gloves", "=ds=#sr# 265"};
		{ 10, "s19052", "15084", "=q3=Wicked Leather Bracers", "=ds=#sr# 265"};
		{ 11, "s19049", "15083", "=q3=Wicked Leather Gauntlets", "=ds=#sr# 260"};
		{ 12, "s10572", "8212", "=q3=Wild Leather Leggings", "=ds=#sr# 250"};
		{ 13, "s10566", "8213", "=q3=Wild Leather Boots", "=ds=#sr# 245"};
		{ 14, "s10560", "8202", "=q3=Big Voodoo Pants", "=ds=#sr# 240"};
		{ 15, "s10558", "8197", "=q3=Nightscape Boots", "=ds=#sr# 235"};
		{ 16, "s10548", "8193", "=q3=Nightscape Pants", "=ds=#sr# 230"};
		{ 17, "s10546", "8214", "=q3=Wild Leather Helmet", "=ds=#sr# 225"};
		{ 18, "s10544", "8211", "=q3=Wild Leather Vest", "=ds=#sr# 225"};
		{ 19, "s10531", "8201", "=q3=Big Voodoo Mask", "=ds=#sr# 220"};
		{ 20, "s10529", "8210", "=q3=Wild Leather Shoulders", "=ds=#sr# 220"};
		{ 21, "s10520", "8200", "=q3=Big Voodoo Robe", "=ds=#sr# 215"};
		{ 22, "s10516", "8192", "=q3=Nightscape Shoulders", "=ds=#sr# 210"};
		{ 23, "s10507", "8176", "=q3=Nightscape Headband", "=ds=#sr# 205"};
		{ 24, "s10499", "8175", "=q3=Nightscape Tunic", "=ds=#sr# 205"};
		{ 25, "s3779", "4264", "=q3=Barbaric Belt", "=ds=#sr# 200"};
		{ 26, "s10490", "8174", "=q4=Comfortable Leather Hat", "=ds=#sr# 200"};
		{ 27, "s9207", "7390", "=q3=Dusky Boots", "=ds=#sr# 200"};
		{ 28, "s9208", "7391", "=q3=Swift Boots", "=ds=#sr# 200"};
		{ 29, "s9206", "7387", "=q3=Dusky Belt", "=ds=#sr# 195"};
		{ 30, "s3777", "4260", "=q3=Guardian Leather Bracers", "=ds=#sr# 195"};
	...
	AtlasLoot_Data["LeatherLeatherArmorOld4"] = {
		{ 1, "s21943", "17721", "=q3=Gloves of the Greatfather", "=ds=#sr# 190"};
		{ 2, "s9202", "7386", "=q3=Green Whelp Bracers", "=ds=#sr# 190"};
		{ 3, "s6705", "5783", "=q3=Murloc Scale Bracers", "=ds=#sr# 190"};
		...
		{ 19, "s3771", "4254", "=q3=Barbaric Gloves", "=ds=#sr# 150"};
		{ 20, "s9149", "7359", "=q3=Heavy Earthen Gloves", "=ds=#sr# 145"};
		{ 21, "s3764", "4247", "=q3=Hillman's Leather Gloves", "=ds=#sr# 145"};
		{ 22, "s3769", "4252", "=q3=Dark Leather Shoulders", "=ds=#sr# 140"};
		{ 23, "s9148", "7358", "=q3=Pilferer's Gloves", "=ds=#sr# 140"};
		{ 24, "s9147", "7352", "=q3=Earthen Leather Shoulders", "=ds=#sr# 135"};
		{ 25, "s9146", "7349", "=q3=Herbalist's Gloves", "=ds=#sr# 135"};
		{ 26, "s3768", "4251", "=q3=Hillman's Shoulders", "=ds=#sr# 130"};
		{ 27, "s3766", "4249", "=q3=Dark Leather Belt", "=ds=#sr# 125"};
		{ 28, "s9145", "7348", "=q4=Fletcher's Gloves", "=ds=#sr# 125"};
		{ 29, "s3767", "4250", "=q3=Hillman's Belt", "=ds=#sr# 120"};
		{ 30, "s9074", "7285", "=q3=Nimble Leather Gloves", "=ds=#sr# 120"};
	...
	AtlasLoot_Data["LeatherLeatherArmorOld5"] = {
		{ 1, "s9072", "7284", "=q3=Red Whelp Gloves", "=ds=#sr# 120"};
		{ 2, "s3765", "4248", "=q3=Dark Leather Gloves", "=ds=#sr# 120"};
		{ 3, "s7135", "5961", "=q3=Dark Leather Pants", "=ds=#sr# 115"};
		{ 4, "s7954", "6467", "=q3=Deviate Scale Gloves", "=ds=#sr# 105"};
		{ 5, "s7133", "5958", "=q3=Fine Leather Pants", "=ds=#sr# 105"};
		{ 6, "s24940", "20575", "=q3=Black Whelp Tunic", "=ds=#sr# 100"};
		{ 7, "s2169", "2317", "=q3=Dark Leather Tunic", "=ds=#sr# 100"};
		{ 8, "s3762", "4244", "=q3=Hillman's Leather Vest", "=ds=#sr# 100"};
		{ 9, "s9068", "7282", "=q3=Light Leather Pants", "=ds=#sr# 95"};
		{ 10, "s6703", "5781", "=q3=Murloc Scale Breastplate", "=ds=#sr# 95"};
		{ 11, "s8322", "6709", "=q3=Moonglow Vest", "=ds=#sr# 90"};
		{ 12, "s6702", "5780", "=q3=Murloc Scale Belt", "=ds=#sr# 90"};
		{ 13, "s3761", "4243", "=q3=Fine Leather Tunic", "=ds=#sr# 85"};
		{ 14, "s3759", "4242", "=q3=Embossed Leather Pants", "=ds=#sr# 75"};
		{ 15, "s2164", "2312", "=q3=Fine Leather Gloves", "=ds=#sr# 75"};
		{ 16, "s2161", "2309", "=q3=Embossed Leather Boots", "=ds=#sr# 55"};
		{ 17, "s2160", "2300", "=q3=Embossed Leather Vest", "=ds=#sr# 40"};
		{ 18, "s9064", "7280", "=q3=Rugged Leather Pants", "=ds=#sr# 35"};
		{ 19, "s44953", "34086", "=q1=Winter Boots", "=ds=#sr# 285"};
		{ 20, "s6661", "5739", "=q3=Barbaric Harness", "=ds=#sr# 190"};
		{ 21, "s7156", "5966", "=q3=Guardian Gloves", "=ds=#sr# 190"};
		{ 22, "s2166", "2314", "=q4=Toughened Leather Armor", "=ds=#sr# 120"};
		{ 23, "s2167", "2315", "=q3=Dark Leather Boots", "=ds=#sr# 100"};
		{ 24, "s2158", "2307", "=q3=Fine Leather Boots", "=ds=#sr# 90"};
		{ 25, "s3763", "4246", "=q3=Fine Leather Belt", "=ds=#sr# 80"};
		{ 26, "s9065", "7281", "=q3=Light Leather Bracers", "=ds=#sr# 70"};
		{ 27, "s2163", "2311", "=q3=White Leather Jerkin", "=ds=#sr# 60"};
		{ 28, "s3756", "4239", "=q3=Embossed Leather Gloves", "=ds=#sr# 55"};
	...
	AtlasLoot_Data["LeatherMailArmorOld1"] = {
		...
		{ 18, "s19089", "15049", "=q4=Blue Dragonscale Shoulders", "=ds=#sr# 295"};
		{ 19, "s19085", "15050", "=q4=Black Dragonscale Breastplate", "=ds=#sr# 290"};
		{ 20, "s19077", "15048", "=q4=Blue Dragonscale Breastplate", "=ds=#sr# 285"};
		{ 21, "s24655", "20296", "=q4=Green Dragonscale Gauntlets", "=ds=#sr# 280"};
		{ 22, "s19060", "15046", "=q4=Green Dragonscale Leggings", "=ds=#sr# 270"};
		{ 23, "s36076", "29971", "=q4=Dragonstrike Leggings", "=ds=#sr# 260"};
		{ 24, "s19050", "15045", "=q4=Green Dragonscale Breastplate", "=ds=#sr# 260"};
		{ 25, "s10650", "8367", "=q4=Dragonscale Breastplate", "=ds=#sr# 255"};
		{ 26, "s10619", "8347", "=q4=Dragonscale Gauntlets", "=ds=#sr# 225"};
		{ 27, "s19100", "15081", "=q3=Heavy Scorpid Shoulders", "=ds=#sr# 300"};
		{ 28, "s19088", "15080", "=q3=Heavy Scorpid Helm", "=ds=#sr# 295"};
		{ 29, "s19075", "15079", "=q3=Heavy Scorpid Leggings", "=ds=#sr# 285"};
		{ 30, "s19070", "15082", "=q3=Heavy Scorpid Belt", "=ds=#sr# 280"};
		Next = "LeatherMailArmorOld2";
		Back = "LEATHERWORKINGMENU";
	};

	AtlasLoot_Data["LeatherMailArmorOld2"] = {
		{ 1, "s19064", "15078", "=q3=Heavy Scorpid Gauntlets", "=ds=#sr# 275"};
		{ 2, "s19051", "15076", "=q3=Heavy Scorpid Vest", "=ds=#sr# 265"};
		{ 3, "s19048", "15077", "=q3=Heavy Scorpid Bracers", "=ds=#sr# 255"};
		{ 4, "s10570", "8208", "=q3=Tough Scorpid Helm", "=ds=#sr# 250"};
		{ 5, "s10568", "8206", "=q3=Tough Scorpid Leggings", "=ds=#sr# 245"};
		{ 6, "s10564", "8207", "=q3=Tough Scorpid Shoulders", "=ds=#sr# 240"};
		{ 7, "s10554", "8209", "=q3=Tough Scorpid Boots", "=ds=#sr# 235"};
		{ 8, "s10556", "8185", "=q3=Turtle Scale Leggings", "=ds=#sr# 235"};
		{ 9, "s10552", "8191", "=q3=Turtle Scale Helm", "=ds=#sr# 230"};
	...
	AtlasLoot_Data["LeatherCloaks1"] = {
		...
		{ 13, "s9070", "7283", "=q3=Black Whelp Cloak", "=ds=#sr# 100"};
		{ 14, "s7953", "6466", "=q3=Deviate Scale Cloak", "=ds=#sr# 90"};
		{ 15, "s2159", "2308", "=q3=Fine Leather Cloak", "=ds=#sr# 85"};
		{ 16, "s3760", "3719", "=q3=Hillman's Cloak", "=ds=#sr# 150"};
		{ 17, "s2168", "2316", "=q3=Dark Leather Cloak", "=ds=#sr# 110"};
